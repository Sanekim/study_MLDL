...
class DIV2K:
    def __init__(self,
        ...
        if subset == 'train':
            ...
            # self.image_ids = range(1, 101) # 19.09.22. ResourceExhaustedError 문제로 실험, 문제의 원인 아님
        elif subset == 'valid':
            self.image_ids = range(801, 1201)
            # self.image_ids = range(801, 802) # 19.09.22. ResourceExhaustedError 문제로 실험, , 문제의 원인 아님
        else:
...
def random_crop(lr_img, hr_img, hr_crop_size=192, scale=4):
